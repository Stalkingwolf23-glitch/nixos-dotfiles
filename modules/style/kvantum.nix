{self, ...}: {
  flake.modules.homeManager.kvantum = {pkgs, ...}: let
  ...
  in {
    ...
    home.file = {
      ...
      ".config/Kvantum/catppuccin-mocha-blue/catppuccin-mocha-blue.svg".source = "${kvantum}/themes/catppuccin-mocha-blue/catppuccin-mocha-blue.svg";
